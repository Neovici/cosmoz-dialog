import{A as D,w as q,b as g,r as Z,D as J}from"./iframe-DD0cdMtx.js";const N=t=>t??D;function F(t,e,s){return t?e(t):s?.(t)}const K=({slot:t,title:e,className:s,width:n="24",height:o="24",styles:i}={})=>g`
	<svg
		slot=${N(t)}
		class=${`clear-icon ${s??""}`}
		viewBox="0 0 24 24"
